...
<%
BoardVO board = (BoardVO) request.getAttribute("mboard");
...
<form action="modifyBoard.do">
	...
	<table class="table">
		...
		<tr>
			<th>제목</th>
			<td><input type = "text" name = "title" class="form-control" value = "<%=board.getTitle()%>"></td>
		</tr>
		<tr>
			<th>내용</th>
			<td colspan="3"><textarea class="form-control" name = "content" cols="30"
